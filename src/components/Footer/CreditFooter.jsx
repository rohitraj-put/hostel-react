  ...
  return (
    <>
      <footer className="text-gray-600 body-font">
        <div className="subFooterElement d-flex align-items-center align-content-center justify-content-between sm:d-flex-row flex-col bg-dark text-white p-2">
          <p id="credit">Designed 💖 and Created 🔮 by Rohit Rajput</p>
          <span
